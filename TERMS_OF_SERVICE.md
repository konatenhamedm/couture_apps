...
En accédant à et en utilisant la plateforme Ateliya ("le Service"), vous acceptez d'être lié par ces Conditions Générales d'Utilisation ("CGU"). Si vous n'acceptez pas ces conditions, veuillez ne pas utiliser notre service.

## 2. Description du service

### 2.1 Présentation

Ateliya est une plateforme numérique de gestion d'ateliers de couture qui permet aux professionnels de la couture de :
- Gérer leurs clients et leurs mesures
- Organiser leurs réservations et rendez-vous
- Traiter les paiements et la facturation
- Gérer leurs stocks et inventaires
- Communiquer avec leurs clients

### 2.2 Évolution du service
...
Pour utiliser Ateliya, vous devez :
...
- **Compte Couturier** : pour les professionnels de la couture
- **Compte Client** : pour les clients des ateliers
- **Compte Administrateur** : pour la gestion des boutiques

### 3.3 Vérification d'identité

Nous pouvons demander une vérification d'identité pour certaines fonctionnalités, notamment les paiements.

## 4. Utilisation acceptable

### 4.1 Utilisations autorisées

Vous pouvez utiliser Ateliya pour :
- Gérer votre activité de couture de manière professionnelle
- Prendre et gérer des rendez-vous
- Traiter des paiements légitimes
...
- Utiliser des robots ou scripts automatisés non autorisés

### 4.3 Contenu utilisateur

Vous êtes responsable du contenu que vous publiez et garantissez que :
- Vous possédez tous les droits nécessaires
- Le contenu ne viole aucune loi ou droit de tiers
...
- Les frais d'abonnement sont facturés à l'avance
...
### 5.2 Paiements clients

- Nous facilitons les paiements entre couturiers et clients
- Des frais de transaction peuvent s'appliquer
- Les remboursements sont gérés selon notre politique de remboursement

### 5.3 Taxes

Vous êtes responsable de toutes les taxes applicables à votre utilisation du Service.

## 6. Propriété intellectuelle

### 6.1 Propriété d'Ateliya

Ateliya et tous ses éléments (logo, design, code, contenu) sont protégés par les droits de propriété intellectuelle et appartiennent à Ateliya ou à ses concédants.

### 6.2 Licence d'utilisation

Nous vous accordons une licence limitée, non exclusive et révocable pour utiliser le Service conformément à ces CGU.

### 6.3 Contenu utilisateur

Vous conservez vos droits sur votre contenu mais nous accordez une licence pour l'utiliser dans le cadre du Service.

## 7. Confidentialité et protection des données

### 7.1 Politique de confidentialité

Notre traitement de vos données personnelles est régi par notre [Politique de Confidentialité](PRIVACY_POLICY.md).

### 7.2 Sécurité des données

Nous mettons en œuvre des mesures de sécurité appropriées pour protéger vos données, mais ne pouvons garantir une sécurité absolue.

## 8. Responsabilités et garanties

### 8.1 Limitation de responsabilité

Dans les limites autorisées par la loi, Ateliya ne sera pas responsable de :
...
Le Service est fourni "en l'état" sans garantie expresse ou implicite. Nous ne garantissons pas que le Service sera ininterrompu ou exempt d'erreurs.

### 8.3 Indemnisation

Vous acceptez d'indemniser Ateliya contre toute réclamation résultant de votre utilisation du Service ou violation de ces CGU.
...
- Votre accès au Service sera interrompu
- Vos données pourront être supprimées après la période de rétention légale
...
Votre utilisation continue du Service après notification constitue votre acceptation des nouvelles CGU.

## 11. Résolution des litiges

### 11.1 Négociation amiable

En cas de litige, nous encourageons une résolution amiable par négociation directe.

### 11.2 Médiation

Si la négociation échoue, nous pouvons recourir à la médiation avant toute action judiciaire.
...
Ces CGU constituent l'intégralité de l'accord entre vous et Ateliya concernant le Service.
...
**En utilisant Ateliya, vous confirmez avoir lu, compris et accepté ces Conditions Générales d'Utilisation.**