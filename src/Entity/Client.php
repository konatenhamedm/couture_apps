...
{ use TraitEntity;
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
     #[Groups(["group1", "group_type","group_details","group_reservation","group_modeleBoutique","paiement_boutique","paiement_boutique_reservation"])]
    private ?int $id = null;
    ...
    #[Groups(["fichier", "group1","paiement_boutique","paiement_boutique_reservation"])]
